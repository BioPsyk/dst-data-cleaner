...
#+BEGIN_SRC plantuml :file ./docs/images/domain-model1.png :exports results
@startuml
skinparam dpi 300
...
[[file:./docs/images/domain-model1.png]]
...
#+NAME: domain-model2
#+ATTR_HTML: :style max-width: 100%;
#+BEGIN_SRC plantuml :file ./docs/images/domain-model2.png :exports results
@startuml
skinparam dpi 300
skinparam shadowing false
skinparam monochrome true
...
[[file:./docs/images/domain-model2.png]]
